    ...
    <div class="card border-0 shadow-lg rounded-4">
        <div class="card-header text-white rounded-top-4 p-3 bg-gradient-primary">
            <h4 class="mb-0 fw-bold">
                <i class="bi bi-file-earmark-bar-graph-fill me-2"></i> Creditor Wise Report
            </h4>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="creditorReportTable" class="table table-hover align-middle">
...
$(document).ready(function() {
    ...
    $('#exportCsvBtn').click(function() {
        ...
        this.href = "{{ route('admin.reports.creditor-wise.export') }}?date_range=" + range;
    });
});
</script>
@endpush